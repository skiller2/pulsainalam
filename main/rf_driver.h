...
#define RF_TX_NEC_BIT_NUM         8
#define RF_TX_NEC_HEADER_HIGH_US  9000
#define RF_TX_NEC_HEADER_LOW_US   4500
#define RF_TX_NEC_DATA_HIGH_US    560
#define RF_TX_NEC_DATA_LOW_1_US   1690
#define RF_TX_NEC_DATA_LOW_0_US   560
#define RF_TX_NEC_REP_HIGH_US     9000
#define RF_TX_NEC_REP_LOW_US      2250
#define RF_TX_NEC_REP_STOP_US     562
#define RF_TX_NEC_REP_CYCLE       108000
#define RF_TX_WDEV_TIMER_ERROR_US 5 // Timing in advance to reduce errors
#define RF_TX_HW_TIMER_ERROR_US   40 // Timing in advance to reduce errors
...
typedef struct {
    ...
    uint32_t freq;
    rf_tx_timer_t timer; // WDEV timer will be more accurate, but PWM will not work
} rf_tx_config_t;
 ...
 * @param len Length of rf_tx_data, range: 0 < len < (uint16_t)
